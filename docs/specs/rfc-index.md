...
| [RFC-004](RFC-004-unified-package.md) | Unified FlowJet Package (CLI + Server) | Architecture Design | Accepted | 2026-09-17 | 2026-09-17 |
...
- [rfc-history.md](rfc-history.md) - Change history
- [rfc-namings.md](rfc-namings.md) - Terminology reference
- [../drafts/api-spec.md](../drafts/api-spec.md) - Superseded design draft
